...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services', 'ui.router', 'LocalStorageModule'])
...
.config(function($stateProvider, $urlRouterProvider, $httpProvider) {
  ...
  .state('user-dash.addBook', {
    url: '/addBook',
      views: {
          'tab-dashboard1': {
              templateUrl: 'templates/dashboard/AddBook.html',
              controller: 'NewBookCtrl'
          }
      }
  })
  
  .state('user-dash.booksCentral', {
      url: '/booksCentral',
      views: {
          'tab-allbooks': {
              templateUrl: 'templates/dashboard/AllBooks.html',
              controller: 'CentralBookRepCtrl'
          }
      }
  })
  
  .state('user-dash.myBooks', {
      url: '/myBooks',
      views: {
        'tab-dashboard1': {
            templateUrl: 'templates/dashboard/MyBooks.html',
